...
{
	/// <summary>
	/// For testing the Russian GOST 7.79-2000(A) romanization system, <see cref="Russian.Gost7792000A"/>.
	/// </summary>
	public class Gost7792000ATests : TestClass
	{
		private readonly Russian.Gost7792000A _system = new();
